...
namespace Altinn.Platform.Authentication.Tests.Controllers
{
        ...
        : WebApplicationTests(dbFixture, webApplicationFixture)
    {
        ...
        protected override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAccessManagementClient, AccessManagementClientMock>();
            services.AddTransient<IAuthorizationHandler, EndUserResourceAccessHandlerMock>();
            SetupDateTimeMock();
            SetupGuidMock();
        }
        ...
        public async Task SystemUser_Get_ListForPartyId_ReturnsForbidden()
        {
            ...
            // int partyId = 500801; 
            Guid partyUuid = Guid.Parse("00000000-0000-0000-0005-000008000001");
            
            HttpRequestMessage request = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal/agent?party={partyUuid}");
            request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
        ...
        public async Task SystemUser_Get_ListForPartyId_ReturnsNotFound()
        {
            ...
            // int partyId = 500000;
            Guid partyUuid = Guid.Parse("00000000-0000-0000-0005-000000000000");
            HttpRequestMessage request = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal?party={partyUuid}");
            request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpResponseMessage response = await client.SendAsync(request, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task SystemUser_Get_Single_ReturnsOK()
        {
            ...
            HttpRequestMessage createSystemUserRequest = new(HttpMethod.Post, $"/authentication/api/v1/systemuser/internal/create?party={partyUuid}");
            createSystemUserRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            createSystemUserRequest.Content = JsonContent.Create<SystemUserRequestDto>(newSystemUser, new MediaTypeHeaderValue("application/json"));
            HttpResponseMessage createSystemUserResponse = await client.SendAsync(createSystemUserRequest, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task SystemUser_Get_byExternalIdp_Deleted_SystemUser_ReturnNotFound()
        {
            ...
            HttpRequestMessage request2 = new(HttpMethod.Delete, $"/authentication/api/v1/systemuser/internal/?party={partyUuid}&systemUserId={shouldBeCreated.Id}");
        ...
        public async Task SystemUser_Get_byExternalIdp_Deleted_SystemUser_ReturnNotFound_CreateNewWorks()
        {
            ...
            HttpRequestMessage createSystemUserRequest2 = new(HttpMethod.Post, $"/authentication/api/v1/systemuser/internal/create?party={partyUuid}");
            createSystemUserRequest.Content = JsonContent.Create<SystemUserRequestDto>(newSystemUser, new MediaTypeHeaderValue("application/json"));
        ...
        public async Task SystemUser_Get_byExternalIdp_withWrongExternalRef()
        {
            ...
            looukpSystemUserRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetOrgToken("digdir", "991825827", "altinn:maskinporten/systemuser.read", null));
            HttpResponseMessage lookupSystemUserResponse = await client.SendAsync(looukpSystemUserRequest, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task SystemUser_Get_byExternalIdp_WrongScope()
        {
            ...
            looukpSystemUserRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetOrgToken("digdir", "991825827", "altinn:maskinporten/systemuser.wrooong", null));
            HttpResponseMessage lookupSystemUserResponse = await client.SendAsync(looukpSystemUserRequest, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task SystemUser_Get_Single_ReturnsNotFound()
        {
            ...
            HttpRequestMessage looukpSystemUserRequest = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal/single?party={partyUuid}&systemUserId={id}");
            looukpSystemUserRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpResponseMessage lookupSystemUserResponse = await client.SendAsync(looukpSystemUserRequest, HttpCompletionOption.ResponseContentRead);
            SystemUser? systemUserDoesExist = JsonSerializer.Deserialize<SystemUser>(await lookupSystemUserResponse.Content.ReadAsStringAsync(), _options);
        ...
        public async Task SystemUser_Delete_ReturnsOk()
        {
            ...
            HttpRequestMessage request3 = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal/single?party={partyUuid}&systemUserId={shouldBeCreated.Id}");
        ...
        public async Task SystemUser_CreateAndDelegate_Returns_DelegationErrorDetail()
        {
            ...
            int partyId = 500004;
            Guid partyUuid = Guid.Parse("00000000-0000-0000-0005-000000000004");
        ...
        public async Task SystemUser_CreateAndDelegate_Returns_Error()
        {
            ...
            Guid partyUuid = Guid.Parse("00000000-0000-0000-0005-000000000009");
        ...
        public async Task AgentSystemUser_Get_ListForPartyId_ReturnsListOK()
        {
            ...
            HttpRequestMessage listSystemUserRequst = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal/agent?party={partyUuid}");
        ...
        public async Task AgentSystemUser_Get_ListForPartyId_ReturnsForbidden()
        {
            ...
            int partyId = 500801;
            Guid partyUuid = Guid.Parse("00000000-0000-0000-0005-000000000008");
            HttpRequestMessage request = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal?party={partyUuid}");
            HttpResponseMessage response = await client.SendAsync(request, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task AgentSystemUser_Delegate_Post_OK()
        {
            ...
            string getEndpoint = $"/authentication/api/v1/systemuser/internal/agent?party={partyUuid}";

            HttpRequestMessage listSystemUserRequst = new(HttpMethod.Get, getEndpoint);
            listSystemUserRequst.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpResponseMessage listSystemUserResponse = await client2.SendAsync(listSystemUserRequst, HttpCompletionOption.ResponseContentRead);
            List<SystemUser>? list = JsonSerializer.Deserialize<List<SystemUser>>(await listSystemUserResponse.Content.ReadAsStringAsync(), _options);
            ...
            string delegationEndpoint = $"/authentication/api/v1/systemuser/internal/agent/delegation/?party={partyUuid}&systemUserId={systemUserId}";
        ...
        public async Task AgentSystemUser_Delegate_Post_SystemUser_BadRequest()
        {
            ...
            int partyId = 500000;
            Guid partyUuid = new Guid("00000000-0000-0000-0005-000000000000");
        ...
        public async Task AgentSystemUser_Delegate_Post_Unauthorized()
        {
            ...
            int partyId = 500007;
            Guid partyUuid = Guid.Parse("ca00ce4a-c30c-4cf7-9523-a65cd3a40237");
        ...
        public async Task AgentSystemUser_Get_Delegations_ReturnsListOK()
        {
            ...
            HttpRequestMessage listSystemUserRequst = new(HttpMethod.Get, $"/authentication/api/v1/systemuser/internal/agent/delegations?party={partyUuid}&systemUserId={systemUserId}");
            listSystemUserRequst.Headers.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpResponseMessage listSystemUserResponse = await client2.SendAsync(listSystemUserRequst, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task AgentSystemUser_DeleteCustomer_ReturnsOk()
        {
            ...
            HttpRequestMessage request3 = new(HttpMethod.Delete, $"/authentication/api/v1/systemuser/internal/agent/delegation/?delegationId={delegationId}&party={partyUuid}");
        ...
        public async Task AgentSystemUser_DeleteCustomer_ReturnsBadRequest()
        {
            ...
            HttpClient client = CreateClient();
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpRequestMessage request = new(HttpMethod.Delete, $"/authentication/api/v1/systemuser/internal/agent/delegation?party={facilitatorId}&delegationId{delegationId}");
            HttpResponseMessage response = await client.SendAsync(request, HttpCompletionOption.ResponseContentRead);
        ...
        {
            Guid facilitatorId = new Guid("00000000-0000-0000-0005-000000000000");
            Guid delegationId = Guid.NewGuid();
        ...
        public async Task AgentSystemUser_DeleteAgent_ReturnsOk()
        {
            ...
            HttpClient client3 = CreateClient();
            client3.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpRequestMessage request3 = new(HttpMethod.Delete, $"/authentication/api/v1/systemuser/internal/agent?party={facilitatorId}&systemUserId={systemUserId}");
            HttpResponseMessage response3 = await client3.SendAsync(request3, HttpCompletionOption.ResponseContentRead);
            Assert.Equal(HttpStatusCode.OK, response3.StatusCode);
        }
        ...
        public async Task AgentSystemUser_DeleteAgent_ReturnsBadRequest()
        {
            ...
            HttpClient client3 = CreateClient();
            client3.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", PrincipalUtil.GetToken(1337, null, 3));
            HttpRequestMessage request3 = new(HttpMethod.Delete, $"/authentication/api/v1/systemuser/internal/agent?party={partyUuid}&systemUserId={systemUserId}");
            HttpResponseMessage response3 = await client3.SendAsync(request3, HttpCompletionOption.ResponseContentRead);
        ...
        public async Task AgentSystemUser_DeleteAgent_ReturnsBadRequest_For_TooManyAssignment()
        {
            ...
            int partyId = 500008;
            Guid partyUuid = Guid.Parse("23478729-1ffa-49c7-a3d0-6e0d08540e9a");
            ...
            var systemUserApproveResponse = await getResponse.Content.ReadFromJsonAsync<List<SystemUser>>();
            Assert.NotEmpty(systemUserApproveResponse);
