...
public class AccessManagementClientMock: IAccessManagementClient    
{
    ...
    public async Task<Result<List<AgentDelegationResponse>>> DelegateCustomerToAgentSystemUser(Guid party, SystemUser systemUser, AgentDelegationInputDto request, int userId, CancellationToken cancellationToken)
    {
