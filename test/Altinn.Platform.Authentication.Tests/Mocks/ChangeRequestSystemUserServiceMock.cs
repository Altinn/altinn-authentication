...
namespace Altinn.Platform.Authentication.Tests.Mocks
{
    ...
    public class ChangeRequestSystemUserServiceMock : IChangeRequestSystemUser
    {
        ...
        public Task<Result<ChangeRequestResponse>> CreateChangeRequest(ChangeRequestSystemUser createRequest, OrganisationNumber vendorOrgNo, SystemUser systemUser, Guid correllationId)
        {
            throw new NotImplementedException();
        }
