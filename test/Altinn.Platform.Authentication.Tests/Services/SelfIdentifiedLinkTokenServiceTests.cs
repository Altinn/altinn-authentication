...
public class SelfIdentifiedLinkTokenServiceTests
{
    ...
    private const int TargetUserId = 4242;
    ...
    public async Task Validate_WrongAudience_IsInvalid()
    {
        ...
        string token = await minting.MintAsync(SourceUserId, TargetUserId);
