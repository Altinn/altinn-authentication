...
namespace Altinn.Platform.Authentication.Tests.Utils
{
    public static class OidcScenarioHelper
    {
        public static OidcTestScenario GetScenario(string scenarioId)
        {
            ...
            if (string.IsNullOrEmpty(scenario.UpstreamProviderCode))
            {
                // This would normally be generated by the upstream provider (Idporten) and sent to the callback endpoint.
