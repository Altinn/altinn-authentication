...
namespace Altinn.Platform.Authentication.Services
{
    ...
    public class OidcServerService : IOidcServerService
    {
        ...
        public async Task<AuthorizeResult> Authorize(AuthorizeRequest request)
        {
            ...
            // TODO: response_type == "code" (case sensitive per spec)
            // TODO: scopes contains "openid"
            // TODO: redirect_uri is absolute
            // TODO: code_challenge present && code_challenge_method == "S256"
            // TODO: validate prompt combination; max_age >= 0; well-formed ui_locales/acr_values

            // If redirect_uri valid for client, prepare ErrorRedirectToClient; else LocalError.
            // Example:
            // return AuthorizeResult.ErrorRedirect(validatedRedirectUri, "invalid_request", "code_challenge_method must be S256", request.State);
