...
public interface IChangeRequestSystemUser
{
    ...
    /// <param name="requestId">A UUID generated by the Vendor, used to uniquely identify the Change Request throughout it's entire lifecylce</param>
    ...
    /// <param name="correllationId">A Guid generated by the Vendor</param>
    /// <returns>Result of Response model or Problem description</returns>
    Task<Result<ChangeRequestResponse>> CreateChangeRequest(ChangeRequestSystemUser createRequest, OrganisationNumber vendorOrgNo, SystemUserInternalDTO systemUser, Guid correllationId);
    ...
    Task<Result<ChangeRequestResponse>> VerifySetOfRights(ChangeRequestResponse validateSet, SystemUserInternalDTO systemUser, OrganisationNumber vendorOrgNo);
