...
public interface ISystemUserService
{
    ...
    /// <param name="partyUUId">the guid of party</param>
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns></returns>
    Task<Result<bool>> DeleteClientDelegationToAgentSystemUser(string partyId, Guid delegationId, Guid partyUUId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns></returns>
    Task<Result<bool>> DeleteAgentSystemUser(string partyId, Guid systemUserId, Guid partyUUId, CancellationToken cancellationToken = default);
}
