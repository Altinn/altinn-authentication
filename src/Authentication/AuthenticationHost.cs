...
internal static class AuthenticationHost
{
    ...
    private static readonly string ApplicationInsightsConnectionString = string.Empty;
    private static readonly string PostgresAdminConnectionString = string.Empty;
    private static readonly string PostgresUserConnectionString = string.Empty;
    ...
    internal void ConfigurePostgreSql(this WebApplication app, WebApplicationBuilder builder)
    {
