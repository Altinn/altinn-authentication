...
namespace Altinn.Platform.Authentication.Core.Services.Interfaces
{
    ...
    public interface ITokenIssuer
    {
        ...
        /// </summary>
        Task<string> CreateAccessTokenAsync(ClaimsPrincipal principal, DateTimeOffset expiry, CancellationToken cancellationToken = default);

        /// <summary>
        /// Create a signed ID token for the given authorization code context and client.
        /// Returns null if <c>openid</c> was not requested.
        /// </summary>
        Task<string> CreateIdTokenAsync(ClaimsPrincipal principal, OidcClient client, DateTimeOffset now, CancellationToken cancellationToken = default);
    }
}
