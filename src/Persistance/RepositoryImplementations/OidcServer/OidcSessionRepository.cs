...
/// </summary>
public sealed class OidcSessionRepository(NpgsqlDataSource ds, ILogger<OidcSessionRepository> logger, TimeProvider timeProvider, IMetricsProvider metricsProvider) : IOidcSessionRepository
{
    ...
    private readonly Metrics telemetry = metricsProvider.Get<Metrics>();
